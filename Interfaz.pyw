...
def ejecutar_archivo_captura():
    try:
        ruta_archivo_captura = r"C:\Users\DIEGO\Desktop\SW1\Proyecto_phyton_sw1\proysw\capturar_imagenes.py"
...
def ejecutar_archivo_modelo():
    try:
        ruta_archivo_modelo = r"C:\Users\DIEGO\Desktop\SW1\Proyecto_phyton_sw1\proysw\entrenar_modelo.py"
...
def ejecutar_archivo_reconocimiento():
    try:
        ruta_archivo_reconocimiento = r"C:\Users\DIEGO\Desktop\SW1\Proyecto_phyton_sw1\proysw\reconocimiento_tiempo_real.py"  # Cambia el nombre del archivo aquí
